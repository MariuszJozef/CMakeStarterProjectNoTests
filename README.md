...
* However this solution file is *transient*: any modifications made from within VS will be overwritten upon subsequent invokation of CMake generator: `cmake -S . -B buildVS/x64/Msvc -G "Visual Studio 17 2022" -A x64`.
